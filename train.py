...
import opts
import models
if os.getenv('LOADER', '') == 'old':
    from dataloader_old import *
elif os.getenv('LOADER', '') == 'm2':
    from m2dataloader import *
elif os.getenv('LOADER', '') == 'm2xe':
    from m2xedataloader import *
else:
...
def train(opt):
    ...
    if 'iterators' in infos:
        ...
        infos['loader_state_dict'] = {'split_ix': infos['split_ix'], 'iterators': infos['iterators']}
