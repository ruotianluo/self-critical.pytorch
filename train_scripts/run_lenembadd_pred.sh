...
python train.py --id $id --caption_model lenemb --decide_length lenemb_predict --input_json data/cocotalk.json --input_label_h5 data/cocotalk_label.h5 --input_fc_dir data/cocobu_fc --input_att_dir data/cocobu_att --seq_per_img 5 --batch_size 50 --beam_size 1 --learning_rate 5e-4 --learning_rate_decay_start 0 --scheduled_sampling_start 0 --checkpoint_path $ckpt_path $start_from --save_every_epoch --save_checkpoint_every 3000 --language_eval 1 --val_images_use 5000 --max_epochs 30 --lenemb_mode add
